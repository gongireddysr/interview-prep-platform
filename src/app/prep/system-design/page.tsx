...
const questionsWithHints = [
  {
    ...
    hints: [
      "Start with requirements: read-heavy or write-heavy?",
      "Consider hash generation strategies",
      "Think about database choice: SQL vs NoSQL",
      "Address scalability: caching, load balancing",
      "Discuss analytics and expiration features",
    ],
  },
  {
    ...
    hints: [
      ...
      "Think about message storage and retrieval",
      "Address presence indicators and typing status",
      "Plan for group chats and direct messages",
      "Consider notification systems and offline support",
    ],
  },
];
